object frmEditMedLog: TfrmEditMedLog
  ...
  object grpMain: TGroupBox
    ...
    object lblInjectionSite: TLabel
      Left = 248
      Top = 68
      Width = 64
      Height = 13
    ...
    object cbxInjectionSite: TComboBox
      ...
      ItemHeight = 0
      TabOrder = 6
      Text = 'cbxInjectionSite'
      OnChange = cbxInjectionSiteChange
      OnEnter = cbxInjectionSiteEnter
      OnExit = cbxInjectionSiteExit
    end
