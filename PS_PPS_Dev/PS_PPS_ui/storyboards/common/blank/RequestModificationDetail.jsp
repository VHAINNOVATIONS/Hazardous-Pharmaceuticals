...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <div>
        <p>
        Note: Clicking the "Accept" button will immediately save the confirmed changes to the database.
        </p>
        </div>
                        <div class="resultsList">
						<%
                        String fileName1 = "http://localhost:8080/PRE/data/requestModification/editableRequestModificationDetail.csv";
                  ...
                  <br/><br/><br/><br/>
                  <fieldset class="fieldset">
                  <legend><strong>Modification Request Summmay for Non-Editable VA Data Fields</strong></legend>
                  <div>
        <p>
        Note: Clicking the "Accept" button will not save the changes to the database, instead it will send the modification request to the national for review.
        </p>
                    <div class="resultsList">
						<%
                        String fileName = "http://localhost:8080/PRE/data/requestModification/RequestModificationDetail.csv";
