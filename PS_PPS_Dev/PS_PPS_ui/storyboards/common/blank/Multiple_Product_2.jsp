	...
	<div id="highestLevel" class="heading">
        <div class="generalInfo">
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
              <tr> 
              	<td valign="top"><div class="productId"><b>Product:</b> LOTREL 30-40 MG CAP</div colLeft></td>
                <td><strong><div class="orderableItem"><strong>Orderable Item:</strong> <a href="#">Lotrel</a></div></td>
              </tr>
              <tr>
                <td width="572" height="22" valign="top"><strong>VUID</strong>: 021154-3257</td>
				<td height="22" valign="top"><label id="genName"><strong>Generic Name:</strong> AMLODIPINE-BENAZEPRIL</label></td>
              </tr>
              <tr>
                <td height="21" valign="top"><label id="gcn"><strong>GCN Seq Number:</strong> 021155</label></td>
