	...
	<div id="highestLevel" class="heading">
        <div class="generalInfo">
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
              <tr> 
              	<td valign="top"><div class="productId"><b>Product:</b> Lotrel 10-20 mg CAP</div colLeft></td>
              ...
              <tr>
                ...
                <td height="21" valign="top"><strong>Drug Class:</strong> ACE Inhibitors-Calcium Blockers Combinations</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
    ...
    <div id="TabbedPanels1" class="TabbedPanels">
        ...
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                <jsp:include page="Amlodipine_ExternalDataFields.jsp"/>
            </div tab1>
            <div class="TabbedPanelsContent">
