...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="60%" valign="top"align="left"><h2>Modification Summary for NDC: Risperidone 2mg TAB 50458-0320-28</h2></td>
    ...
    <div>
        ...
        Note: Clicking the "Accept" button will immediately save the confirmed changes to the national database.
						...
						<%
                        String fileName1 = "http://localhost:8080/PRE/data/requestModification/nationalRequestModificationDetail_ndc.csv";
