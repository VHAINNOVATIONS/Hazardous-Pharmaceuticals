...
<div class="mainBody">
	<div id="highestLevel" class="heading">
        <div class="generalInfo">
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
              ...
              <tr>
                <td width="572" height="21" valign="top"><strong>VUID:</strong> 021154-3256</td>
				<td height="21" valign="top"><label id="genName"><strong>Generic Name:</strong> Risperidone</label></td>
              </tr>
              <tr>
    ...
    <div id="buttons" class="buttonPanel">
        ...
        <input name="SaveAndSubmit" type="submit" class="buttonCenter" onclick="MM_openBrWindow('NationalModificationSummary.jsp','VADFNonEditableModSummary','width=950,height=500')" value="Submit" />
        <input name="OpenAsaTemplate" type="button" class="buttonRight" value="Open As a Template" />
    </div buttonPanel>
</div mainBody>
