...
<form id="localItemDetail" name="localItemDetail" method="post" action="New_Local_ItemDetail.jsp">
    <div id="CollapsiblePanel1" class="CollapsiblePanel">
        <div class="CollapsiblePanelTab" tabindex="0">
        	External Data Fields        </div collapsiblePanelTab>
  ...
  <div align="right">
  <p>
<input name="save" type="submit" onClick="MM_popupMsg('This Item is Locked by jwood.')" value="Save and Submit">
</p>
</div>
</form>
</div>
