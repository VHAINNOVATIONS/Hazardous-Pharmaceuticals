...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableFont"><tr height="50"><td width="61%" rowspan="2"><table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableFont">
  ...
  <tr>
    ...
    <td><input name="tradeName" type="text" id="tradeName"  class="text_leftalign" value="Amlodipine"/></td>
    <td align="right">Route:</td>
    <td><input name="route" type="text" id="route" class="text_leftalign" value="Oral"/></td>
  </tr>
  <tr>
    <td height="30">Generic Name:</td>
    <td><input name="genericName" type="text" id="genericName" class="text_leftalign" value="Amlodipine-Benazepril"/></td>
  ...
  <tr>
    ...
    <td><input name="strength" type="text" id="strength" class="text_rightalign" size="2" value="2"/>&nbsp;
      <select name="cmbUnit">
      <option>mg</option>
      <option>ml</option>
    </select></td>
    ...
    <option>Anti-Psychotic</option>
      <option selected="selected">ACE Inhibitors-Calcium Blockers Combinations</option>
    </select></td>
  </tr> 
</table>  
<label></label></td>
