...
<fieldset style="border-color:#000000" class="searchFieldset">
        ...
        <div class="searchBottom">
            ...
            <div class="bottomRight">
                ...
                <br/>
                <input name="Open Blank Product Template" type="button" onClick="MM_goToURL('parent','03_National_Product.jsp');return document.MM_returnValue" value="Open Blank Product Template">
            </div>
        </div searchBottom>
    </form>
</div pageBody>
