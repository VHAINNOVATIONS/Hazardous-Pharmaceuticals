...
<div class="mainBody">
    ...
    <div id="TabbedPanels1" class="TabbedPanels">
        ...
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                <jsp:include page="03_NationalExternalDataFields.jsp"/>
            </div tab1>
            <div class="TabbedPanelsContent">
    ...
    <div id="buttons" class="buttonPanel">
        ...
        <input name="OpenAsaTemplate" type="button" class="buttonRight" onclick="MM_goToURL('parent','04_National_Product_Template.jsp');return document.MM_returnValue" value="Open As a Template" />
    </div buttonPanel>
</div mainBody>
<script type="text/javascript">
<!--
