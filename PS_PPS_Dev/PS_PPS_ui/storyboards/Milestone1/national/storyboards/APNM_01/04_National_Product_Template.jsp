...
<div class="mainBody">
    ...
    <div id="TabbedPanels1" class="TabbedPanels">
        ...
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                <jsp:include page="04_Editable_ExternalDataFields.jsp"/>
            </div tab1>
            <div class="TabbedPanelsContent">
    ...
    <div id="buttons" class="buttonPanel">
        ...
        <input name="SaveAndSubmit" type="submit" class="buttonCenter" value="Submit" onClick="MM_goToURL('parent','05_Confirmation.jsp');return document.MM_returnValue"/>
