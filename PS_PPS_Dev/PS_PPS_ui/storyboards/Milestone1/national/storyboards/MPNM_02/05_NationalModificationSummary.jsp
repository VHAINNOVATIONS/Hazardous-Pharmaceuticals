...
<body>
 <div id="pageTitle" class="pageTitle">
	Modification Summary for NDC: Risperidone 2 mg TAB <span class="productId">50458-0320-28</span></div>
<form action="" method="get">
  ...
  <div class="button">	
	        <input name="close" type="button" value="Confirm Changes" class="button" onClick="to_old_win('06_Confirmation.jsp')"/>
