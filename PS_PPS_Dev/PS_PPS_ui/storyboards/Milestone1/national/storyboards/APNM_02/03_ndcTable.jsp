...
<body>
    <div id="table" class="searchTable">
        <table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#000000" RULES="COLS" FRAME="box" >
            ...
            <tr bgcolor="#DEEFFF";>
            	<td align="right"><a href="#" target="_parent">50458-0320-28</a></td>
            	<td align="left">Risperdal</td>
            	<td align="left">TABLET</td>
        ...
        <br/>
        <input type="button" class="buttonRight" onclick="MM_goToURL('parent','04_National_AddNew_NDC_WithoutTemplate.jsp');return document.MM_returnValue" value="Open Blank NDC Template" />
    </div searchTable>
</body>
