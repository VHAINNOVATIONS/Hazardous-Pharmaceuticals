...
<div class="mainBody">
    ...
    <div id="buttons" class="buttonPanel">
        ...
        <input name="SaveAndSubmit" type="submit" class="buttonCenter" onclick="MM_openBrWindow('04_NationalModificationSummary.jsp','','resizable=yes,width=850,height=400')" value="Submit" />
