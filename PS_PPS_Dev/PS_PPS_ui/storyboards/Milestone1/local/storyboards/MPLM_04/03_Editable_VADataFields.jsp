          ...
          <input name="DQL1" type="text" id="DQL1" value="2"  style="text-align:right" size="2"/>
            <select name="DispenseUnit"  id="DispenseUnit">
              <option>Not Selected</option>
                ...
                <a href="#" class="edit" id="EditDispMsg">edit</a>
                <br/>
                <input type="text" name="DSL" id="DSL" size="3" disabled="disabled" style="text-align:right" value="30"/>
                days
                <a href="03_Product_DaysSuppLim_Editable.jsp" class="edit" id="EditDaysSuppLimit">edit</a>
                <br />
