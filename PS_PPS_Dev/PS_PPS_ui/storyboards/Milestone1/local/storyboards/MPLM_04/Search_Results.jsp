...
<fieldset style="border-color:#000000" class="searchFieldset">
            <div id="searchResults" class="searchResults">
	  		...
	  		<div id="searchTable" class="searchTable">
                <table  id="searchTbl" width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#000000" RULES="COLS" FRAME="box" >
                    <tr align="center">
                    	<th align="center">&nbsp;</th>
                                <th>Generic Name</th>
                                <th>STR</th>
                    ...
                    <tr align="left" bgcolor="#FFFFFF">
	                    <td align="center"><input name="" type="checkbox" value="" /></td>
								<td align="left"><a href="ItemDetail.jsp" target="_self" id="risp1">Risperidone</a></td>
                    ...
                    <tr align="left" bgcolor="#DEEFFF">
	                    <td align="center"><input name="" type="checkbox" value="" /></td>
								<td align="left"><a href="ItemDetail.jsp" target="_self" id="risp2">Risperidone</a></td>
                            	<td align="right">0.25</td>
                            	<td align="left">ml</td>
                            <td align="left">TAB</td>
                            <td align="left">Anti-Psychotic</td>
                    ...
                    <tr align="left" bgcolor="#FFFFFF">
	                    <td align="center"><input name="" type="checkbox" value="" /></td>
								<td align="left"><a href="ItemDetail.jsp" target="_self" id="risp3">Risperidone</a></td>
                    ...
                    <tr align="left" bgcolor="#DEEFFF">
	                    <td align="center"><input name="" type="checkbox" value="" /></td>
								<td align="left"><a href="ItemDetail.jsp" target="_self">Risperidone</a></td>
                            	<td align="right">0.50</td>
                            	<td align="left">mg</td>
                            <td align="left">TAB</td>
                            <td align="left">Anti-Psychotic</td>
                    ...
                    <tr align="left" bgcolor="#FFFFFF">
	                    <td align="center"><input name="" type="checkbox" value="" /></td>
								<td align="left"><a href="02_Product.jsp" id="risp4">Risperidone</a></td>
                            ...
                            <td align="left">Active</td>
                            <td align="left">Non-Formulary</td>
                            <td align="right"><a href="02_NDC_List.jsp">4</a></td>
                  </tr>        
                    <tr align="left" bgcolor="#DEEFFF">
	                    <td align="center"><input name="" type="checkbox" value="" /></td>
								<td align="left"><a href="ItemDetail.jsp" target="_self">Risperidone</a></td>
