...
<form action="" method="get">
	<div class="mainBody">
                    ...
                    <div class="resultsList">
                        <table border="1" cellpadding="2" cellspacing="0" bordercolor="#000000" RULES="COLS" FRAME="box" >
                            <tr>
                                ...
                                <tr bgcolor="#FFFFFF";>
                                <td align="center"><input name="confirmChkBox1" type="checkbox" value="" checked="checked"/></td>
                                <td align="left">Quantity Dispense Msg</td>
                                <td align="left">Dispensed for 30 days at a time</td>
                                <td align="left">Dispensed for 30 days at a time</td>
                                <td align="center"><input name="makeEditableChkBox1" type="checkbox" value="" /></td>
                                <td width="20%" align="justify"><input name="input" type="text" size="50" value="" /></td>         	
                              </tr>
                              
                                <tr bgcolor="#DeeFFF";>
                                <td align="center"><input name="" type="checkbox" value="confirmChkBox2" checked="checked"/></td>
                                <td align="left">Days Supply Limit</td>
                                <td align="right">30</td>
                                <td align="right">42</td>
                                <td align="center"><input name="makeEditableChkBox2" type="checkbox" value="" /></td>
                                <td width="20%" align="justify"><input name="input" type="text" size="50" value="" /></td>    	
                              </tr>
        ...
        <div class="button">	
		  <input name="ConfirmChanges" type="button" value="Confirm Changes" onClick="to_old_win('05_Confirmation.jsp')"/>
