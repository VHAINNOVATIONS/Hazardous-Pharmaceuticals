...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableFont"><tr height="50"><td width="61%" rowspan="2"><table width="100%" border="0" cellspacing="1" cellpadding="0" class="tableFont">
  ...
  <tr>
    ...
    <td><input name="tradeName" type="text" id="tradeName"  class="text_leftalign" value="Risperdal M-TAB"/></td>
  ...
  <tr>
    ...
    <td><input name="genericName" type="text" id="genericName" class="text_leftalign" value="Risperidone"/></td>
  ...
  <tr>
    ...
    <option selected="selected">Anti-Psychotic</option>
