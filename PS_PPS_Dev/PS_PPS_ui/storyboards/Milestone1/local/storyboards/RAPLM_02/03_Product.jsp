...
<div class="mainBody">
    ...
    <div id="buttons" class="buttonPanel">
        ...
        <input class="buttonRight" name="Close" type="button" onclick="MM_goToURL('parent','04_AddNew_Product.jsp');return document.MM_returnValue" value="Open As a Template" />
    </div buttonPanel>
</div mainBody>
<script type="text/javascript">
<!--
