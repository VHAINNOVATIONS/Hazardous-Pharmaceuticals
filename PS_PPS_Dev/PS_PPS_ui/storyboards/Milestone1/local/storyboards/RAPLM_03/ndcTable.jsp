...
<body>
    <div id="table" class="searchTable">
        ...
        <br/>
        <input type="button" class="buttonRight" onclick="MM_goToURL('parent','04_AddNew_NDC_WithoutTemplate.jsp');return document.MM_returnValue" value="Open Blank NDC Template" />
    </div searchTable>
</body>
