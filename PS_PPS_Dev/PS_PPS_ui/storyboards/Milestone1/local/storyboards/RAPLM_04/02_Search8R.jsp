...
<fieldset style="border-color:#000000" class="searchFieldset">
            <div id="searchResults" class="searchResults">
	  		...
	  		<div id="searchTable" class="searchTable">
                <table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#000000" RULES="COLS" FRAME="box" >
                    ...
                    <tr align="left" bgcolor="#FFFFFF">
	                    <td align="center"><input name="" type="checkbox" value="" /></td>
								<td align="left"><a href="#">Risperidone</a></td>
        ...
        <div class="searchBottom">
            ...
            <div class="bottomRight">
                ...
                <br/>
                <input name="Open Blank Product Template" type="button" onclick="MM_goToURL('parent','03_Blank_Product.jsp');return document.MM_returnValue" value="Open Blank Product Template">
            </div>
        </div searchBottom>
    </form>
</div pageBody>
