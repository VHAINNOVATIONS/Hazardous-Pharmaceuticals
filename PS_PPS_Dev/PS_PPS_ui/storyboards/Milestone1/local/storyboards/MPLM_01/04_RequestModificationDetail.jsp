...
<body>
 <div id="pageTitle" class="pageTitle">
	Modification Summary for NDC:  Risperidone 2 mg TAB <span class="inputColumn">50458-0320-0</span>1</div>
	...
	<div class="mainBody">
        ...
        <div id="TabbedPanels1" class="TabbedPanels">
            <ul class="TabbedPanelsTabGroup">
              ...
              <li class="TabbedPanelsTab" tabindex="0">Non-Editable VA Data Modifications</li>
          </ul>
                        ...
                        <table border="1" cellpadding="2" cellspacing="0" bordercolor="#000000" RULES="COLS" FRAME="box" >
                            <tr>
                                ...
                                <td align="center"><input name="" type="checkbox" value="" checked="checked"/></td>
                                    <td align="left">Protect From Light</td>
                                    <td align="left">No</td>
        ...
        <div class="button">	
		  <input name="" type="button" value="Confirm Changes" onClick="to_old_win('05_Confirmation.jsp')"/>
