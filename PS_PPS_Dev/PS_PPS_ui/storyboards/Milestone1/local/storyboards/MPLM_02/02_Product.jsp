...
<div class="mainBody">
    ...
    <div id="buttons" class="buttonPanel">
        ...
        <input name="SaveAndSubmit" type="submit" class="buttonCenter" onclick="MM_openBrWindow('03_RequestModificationDetail.jsp','VADFModSummary','width=950,height=300')" value="Submit" />
