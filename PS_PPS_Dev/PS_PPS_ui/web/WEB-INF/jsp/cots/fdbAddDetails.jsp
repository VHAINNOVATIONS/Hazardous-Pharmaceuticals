...
<table  width="900px" style="border-style:solid; border-width:1px;">
    ...
    <tr>
       ...
       <a href="/PRE/fdbAddPrint.go?type=DETAILS"
            onclick="return popupWithOptions(this.href, 'print', 'resizable=yes,scrollbars=no,toolbar=no, width=900,height=650');">Print</a>
        </td>
  </tr>
</table>
