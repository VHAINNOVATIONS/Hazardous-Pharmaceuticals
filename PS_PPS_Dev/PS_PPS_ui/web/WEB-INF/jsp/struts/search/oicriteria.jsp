...
<peps:form id="search">
<fieldset>
    <LEGEND>Search Criteria for Orderable Item Search</LEGEND>
    <div class="row">
        <div class="row">
        ...
        <div class="column"><s:textfield
            ...
            size="15" />&nbsp;(use % as wildcard)</div>
        <div class="column">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
        <div class="column"><s:textfield
            key="searchTemplate.searchCriteria.dosageForm"
            label="%{getLocalizedFieldName('dosage.form')}"
            labelposition="top"
            title="%{getLocalizedFieldDescription('dosage.form')}"
            size="10" /></div> 
        <div class="column">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
