...
<%
            ...
            ListDataField<String> applicationPackageUse = OgnlUtility.findValue(request,
                "item.dataFields['application.package.use']");
...
<div
    ...
    id="outpatient_tab"><a name="outpatient_tab_link"></a> <peps:model ognlPrefix="item">
    <tiles:insertAttribute name="outpatient" />
</peps:model></div>
<div
    class="TabbedPanelsContent"
    id="inpatient_tab"><a name="inpatient_tab_link"></a> <peps:model ognlPrefix="item">
...
<div
    class="TabbedPanelsContent"
    id="ward_stock_tab"><a name="ward_stock_tab_link"></a> <peps:model ognlPrefix="item">
    <tiles:insertAttribute name="ward.stock" />
</peps:model></div>
<div
    class="TabbedPanelsContent"
    id="drug_accountability_tab"><a name="drug_accountability_tab_link"></a> <peps:model ognlPrefix="item">
    <tiles:insertAttribute name="drug.accountability" />
</peps:model></div>
<div
    class="TabbedPanelsContent"
    id="controlled_substance_tab"><a name="controlled_substance_tab_link"></a> <peps:model ognlPrefix="item">
    <tiles:insertAttribute name="controlled.substance.jsp" />
</peps:model></div>
<div
    class="TabbedPanelsContent"
    id="nonva_med_tab"><a name="nonva_med_tab_link"></a> <peps:model ognlPrefix="item">
