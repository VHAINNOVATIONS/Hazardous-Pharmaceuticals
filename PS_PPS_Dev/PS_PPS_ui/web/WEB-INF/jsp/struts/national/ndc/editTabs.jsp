...
<li
    ...
    title="<%=OgnlUtility.getText(request, "click.to.edit.main")%>"><%--<s:text name="ndcmain.tab" /> --%><spring:message code="ndcmain.tab" /></a></li>
<!--  <li
    ...
    title="<%=OgnlUtility.getText(request, "click.to.edit.quickactions")%>"><%-- <s:text name="options.tab" /> --%><spring:message code="options.tab" /></a></li> -->
<li
    ...
    title="<%=OgnlUtility.getText(request, "click.to.edit.price")%>"><%--<s:text name="ndcprice.tab" /> --%><spring:message code="ndcprice.tab" /></a></li>