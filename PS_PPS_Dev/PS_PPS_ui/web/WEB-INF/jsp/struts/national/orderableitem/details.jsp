...
<div class="panel">
    ...
    <fieldset style="width: 460px;"><legend class="legend">Setup</legend>
        <peps:dataField key="application.package.use" labelPosition="None" cssStyle="width: 218px; display: inline;" cssClass="readonlynational" />
        <peps:dataField key="non.va.med" cssClass="aligncheckbox225" />
        <peps:dataField key="categories" cssStyle="width: 218px"/>
        <peps:text key="oi.iv.flag" label="true" cssClass="readonlynational"/>   
    ...
    <div class="threeColumn2left">
    <fieldset style="width: 460px;"><legend class="legend">Formulary</legend>
