...
<li
    ...
    title="<%=OgnlUtility.getText(request, "click.to.edit.details")%>"><s:text name="details.tab" /></a></li>
<!--  <li
...
<li
    ...
    title="<%=OgnlUtility.getText(request, "click.to.edit.safety")%>"><s:text name="safety.tab" /></a></li>
<li
    ...
    title="<%=OgnlUtility.getText(request, "click.to.edit.labsvitals")%>"><s:text name="labs.tab" /></a></li>