...
/**
 * EplOiDrugTextLAssocDo generated by hbm2java
 * 
 * @hibernate.class
 */
public class EplOiDrugTextLAssocDo extends gov.va.med.pharmacy.peps.domain.common.model.DataObject implements
    ...
    private EplOiDrugTextLAssocDoKey key;
    ...
    public EplOiDrugTextLAssocDo() {
    }

    /** minimal constructor */
    
    public EplOiDrugTextLAssocDo(EplOiDrugTextLAssocDoKey key, String createdBy, Date createdDtm) {
        this.key = key;
    ...
    public EplOiDrugTextLAssocDo(EplOiDrugTextLAssocDoKey key, String createdBy, Date createdDtm, String lastModifiedBy,
                                Date lastModifiedDtm, EplDrugTextDo eplDrugText, EplOrderableItemDo eplOrderableItem) {
        this.key = key;
        this.setCreatedBy(createdBy);
        this.setCreatedDtm(createdDtm);
    ...
    // Property accessors
    public EplOiDrugTextLAssocDoKey getKey() {
        return this.key;
    }

    public void setKey(EplOiDrugTextLAssocDoKey key) {
        this.key = key;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof EplOiDrugTextLAssocDo)) {
            return false;
        }
        
        EplOiDrugTextLAssocDo castOther = (EplOiDrugTextLAssocDo) other;
