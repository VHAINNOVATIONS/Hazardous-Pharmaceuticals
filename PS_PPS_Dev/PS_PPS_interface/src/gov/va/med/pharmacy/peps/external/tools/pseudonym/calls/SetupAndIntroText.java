 ...
 */
public class SetupAndIntroText extends AbstractCall {

    /**
     * default no-arg constructor
     */
    public SetupAndIntroText() {
        super();
    }

    /**
     * This method generates the Response object and set's the attribute values of the Response object. 
    ...
    public Response getResponse(Request call) throws PseudonymException {
        return new Response(call, processTemplate(this), "gov.va.med.foundations.security.response",
            "secSetupIntroResponse.xsd");
    }
