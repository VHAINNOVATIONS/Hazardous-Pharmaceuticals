 ...
 */
public class XhdxVerSrv extends AbstractCall {
     ...
     * for the XhdxVerSrv object.
     * 
     * @param call client request
     * @return Response object
     * @exception PseudonymException If an exception occurred they will be encapsulated here.
     * 
