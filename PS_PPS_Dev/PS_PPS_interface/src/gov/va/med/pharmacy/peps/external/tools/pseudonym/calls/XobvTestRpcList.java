 ...
 */
public class XobvTestRpcList extends AbstractCall {

    /**
     * Test ping from Vista
     * 
     * @param parameters Request
     * @return Response for the ping for XobvTestRpcList
    ...
    public Response getResponse(Request parameters) throws PseudonymException {
        return new Response(parameters, "<Response type=\"array\"><![CDATA[XOBV TEST RPC LIST RESPONSE]]></Response>");
    }
}
