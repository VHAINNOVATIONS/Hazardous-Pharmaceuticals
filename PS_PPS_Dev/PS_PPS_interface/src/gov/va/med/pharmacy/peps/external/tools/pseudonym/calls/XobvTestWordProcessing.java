 ...
 */
public class XobvTestWordProcessing extends AbstractCall {
    ...
    public Response getResponse(Request parameters) throws PseudonymException {
        return new Response(parameters, "<Response type=\"array\"><![CDATA[XOBV TEST WORD PROCESSING RESPONSE]]></Response>");
    }
}
