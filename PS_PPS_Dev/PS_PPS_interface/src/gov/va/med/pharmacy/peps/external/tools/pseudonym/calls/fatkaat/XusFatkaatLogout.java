 ...
 */
public class XusFatkaatLogout extends AbstractCall {

    /**
     * default no-arg constructor
     */
    public XusFatkaatLogout() {
        super();
    }

    /**
     * This method generates a Response object and set's the attribute values of the Response object. 
     * In addition, a template file is used to simplify maintainability for the XusFatkaatLogout object.
     * 
