 ...
 */
public class VaDispenseUnitFileConverterTest extends TestCase {
    ...
    public void testAdd() {
        ...
        NdfDomain ndfDomain = NdfDomainConverter.toNdfDomain(new DomainItem[] {new DomainItem(dispenseUnitVo,
        ...
        assertEquals("NAME incorrect.", dispenseUnitVo.getValue(), NdfDomainDocument.instance().unmarshal(
            NdfDomainDocument.instance().marshal(ndfDomain)).getVaDispenseUnitFile().get(0).getName().getValue());
    ...
    public void testModify() {
        ...
        dispenseUnitVo.setValue(newName);
        ...
        assertEquals("Modify NAME incorrect.", dispenseUnitVo.getValue(), NdfDomainDocument.instance().unmarshal(
            NdfDomainDocument.instance().marshal(ndfDomain)).getVaDispenseUnitFile().get(0).getName().getValue());
    ...
    public void testInactivate() {
        ...
        assertEquals("INACTIVATION DATE incorrect.", "01-01-2008", NdfDomainDocument.instance().unmarshal(
            NdfDomainDocument.instance().marshal(ndfDomain)).getVaDispenseUnitFile().get(0).getInactivationDate().getValue()
            .getValue());
